...
// "secret" is Amazon's documented example key, not a real credential.
//
...
const MASK = "[REDACTED:aws-access-key-id:7f3a91d2]";
...
store.upsertLeakEvent({ fingerprint: "dev-aws", sessionId: "devA", detector: "aws-access-key-id",
